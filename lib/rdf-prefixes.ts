...
export const IREMUS_NS_BASE: string = 'http://data-iremus.huma-num.fr/ns/sherlock#'
...
export const E55_TEI_FILE_URI = DATA_IREMUS_ID_BASE + 'f005e36a-4690-4c83-9791-2927f5f823e0'
export const E55_MEI_FILE_URI = DATA_IREMUS_ID_BASE + '12c5795a-d5fd-4730-9c84-833714b6aaef'
export const E55_FORGE_FILE_URI = DATA_IREMUS_ID_BASE + 'f284ed72-139d-4662-9dce-208bf493a45d'
export const E55_BUSINESS_ID = DATA_IREMUS_ID_BASE + '574ffe9e-525c-42f2-8188-329ba3c7231d'
export const SHERLOCK_E55_PROJECT_OVERVIEW_FILE = DATA_IREMUS_ID_BASE + '518e72ac-3471-4483-b633-e07aecfff49c'
